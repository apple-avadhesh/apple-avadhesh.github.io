...
- An optional type for the peroperty can be specified.
...
Original Source: [Link](https://gist.github.com/lnfnunes/f9af5d188b806f9f2538ef43ebe8b70c)
...
Making an Enum obey `CodableEnum` and then implementing the `defaultValue`  will allow you to provide default value a when you come across an unknown case.
